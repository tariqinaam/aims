    ...
    public function __construct() {
      ...
      //  $this->add(new Zend_Acl_Resource('posts'));
       ...
       // $this->addRole(new Zend_Acl_Role('registered'), 'guest');
        ...
        $this->allow('guest', array('error', 'index', 'user'));
        $this->deny('guest', 'user', array('index'));
        $this->allow('guest', 'user', array('login'));
        $this->allow('guest', 'index', array('index', 'thanks'));
